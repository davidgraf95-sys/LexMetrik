...
| 7 | Nordstern 3.7. macht Steuerbehörden/Ämter zur Kernzielgruppe — E6a (ihr Kernarbeitsmittel) liegt erst in Phase 6, obwohl slot-frei (Bund-Strang) und nur E3/E4-abhängig | **ENTSCHIEDEN (David 3.7.2026: «ja»)** | **E6a wird VORGEZOGEN** — Bahn-A-Nebengleis nach Phase 3/4 (Quell-Inventar startet sofort, Bund-Strang/kein Slot); Detail FAHRPLAN-DATENHALTUNG §5 E6a |
...
4. **EIN Freigabe-Paket** [DAVID, ~30 Min, reine Ja/Nein-Entscheide, keine Fachprüfung]: (i) E0-Start (Prozess-Freigabe 5), (ii) Fedlex Paket 1 Currency, (iii) Bestätigung 26×-Kette inkl. Slot-Etikett (E3 zuerst, §10.1), (iv) FUNDAMENT-UMBAU Thema B+C Go/No-Go, (v) GmbH-G2-Go (optional, kann warten), (vi) **Turso-Billing dem Grunde nach + Betragsrahmen/Cap** (einziger Turso-Touchpoint; Rückfrage nur bei Cap-Überschreitung), (vii) **Optional-Frage Abnahme-Welle 1: Feb 2027 (Default) oder Vorziehen auf Dez 2026?** **Stand 3.7.2026 (nachgeführt):** (i) ✅ · (ii) ✅ freigegeben+in Arbeit · (iii) ✅ · (v) **«später» (David 3.7.)** · (vi) ✅ (Turso provisioniert+geladen) · (vii) ✅ **Feb 2027 bestätigt** · (viii) ✅ (Dependabot an, dompurify-Fix PR #88 gemergt) — **offen nur noch (iv) FUNDAMENT-UMBAU Thema B+C Go/No-Go.**
