...
- [~] V5 Verjährungs-Rahmen — ZURÜCKGESTELLT mit Begründung (10.6.2026): Heute existiert nur EIN Konsument (OR-Regime). Die künftigen Regimes mechanisieren ANDERS (DBG 120/121: NEUBEGINN-Katalog + absolute Frist; StGB 97 ff.: Ruhen/Beendigungs-Stufen) — den Rahmen ohne zweiten testbaren Konsumenten zu schneiden hiesse raten (Rule of three, §10: Rahmen ERST beim Bau). Wiedervorlage: mit der §0a-Öffnung von steuer-/straf-verjaehrung (KATALOG-ROADMAP C Rang 7/Teil D).
