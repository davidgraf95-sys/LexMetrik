...
| [fedlex-currency-2026-07-03.md](register/fedlex-currency-2026-07-03.md) | **Fedlex-Currency-Lauf Paket 1** (neu 3.7.2026, QS-CURRENCY): 18 stale Snapshots + EMRK/NYÜ-PDF-Embeds auf die geltende Konsolidierung nachgezogen (je Erlass alt→neu-Pin, Artikel-Delta, kein Verlust, 54/54 Wortlaut-Stichproben); P1-b-Härtung (Pin-Regex-Fix 207→218 überwachte Pins, Coverage-Assertion, `check:pdf-netz`-LIMIT-300-Fix, Gegenprüfungs-Glob `scripts/fedlex-*`); html-N-Falle klv=8/vrv=8/ssv=14 via `isExemplifiedBy` | offen P1-c (56 künftige Fassungen → Verfallsregister) + P1-d (Currency-Chips) |
