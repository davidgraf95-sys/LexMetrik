...
⚠ **Methodische Einschränkung dieses Teils:** EG-StPO-Artikel-Mappings sind
überwiegend nur Snippet-belegt (signierte PDFs nicht zeichengenau auslesbar)
— vor Stammdaten-Übernahme am Volltext verifizieren. Volltext-/nummern-fest
nur GE (LOJ Art. 76–82A/111), AI (EG-StPO Art. 5–8/15), Bund (StBOG 7–9,
23–31).
...
# Strafverfolgungsbehörden — Kantone SH · AR · AI · SG · GR · AG · TG · TI · VD · VS · NE · GE · JU + Bund

**Abrufdatum aller Quellen: 5.6.2026** · Nur Web-Recherche (amtliche Kantons-/Bundesseiten, ssk-cmp.ch Behördenverzeichnis, lexfind, Fedlex). Strafgerichte/Zwangsmassnahmengerichte (ZMG) sind in den bestehenden Repo-Dossiers `gerichtsbehoerden-kantone.md` und `gog-gerichtsorganisation-kantone.md` erfasst — hier nur Querverweis, nicht gedoppelt.

**Methodischer Hinweis / Unsicherheit (gilt durchgehend):** Die amtlichen Erlasstexte liegen fast überall nur als signierte PDFs vor, die sich nicht zeichengenau ausziehen liessen. **Die Adressen/Strukturen sind web-amtlich belegt; die exakten Artikelnummern der EG-StPO-Mappings sind teils nur grob/Snippet-belegt und vor Stammdaten-Übernahme am amtlichen Volltext gegenzulesen.** Diese Stellen sind je Kanton markiert (⚠ Art.-Nr. verifizieren). Anders als bei den Gerichts-Dossiers wurde hier **kein** PDF-Volltextabgleich erreicht.
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | Geleitet von der/dem **Ersten Staatsanwältin/Staatsanwalt**. Abteilungen: **Allgemeine Abteilung**, **Verkehrsabteilung**, **Abteilung Jugendanwaltschaft**. Zugeordnet dem Volkswirtschaftsdepartement. |
| **Adressen** | Allgemeine Abteilung: **Beckenstube 7 (Regierungsgebäude), 8200 Schaffhausen**. Verkehrsabteilung: **Bahnhofstrasse 29 (Bahnhofgebäude), 8200 Schaffhausen**. |
| **Jugendanwaltschaft** | Abteilung der StA: **J. J. Wepfer-Strasse 6, 8200 Schaffhausen**. |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | Keine eigene/separate Übertretungsstrafbehörde im Behördenverzeichnis ausgewiesen — Übertretungen laufen über die StA. (⚠ Gemeinde-/Polizei-Bussenkompetenz nicht abschliessend verifiziert.) |
| **EG-StPO** | SH hat **kein separates EG-StPO**: Organisation der Strafbehörden steht im **Justizgesetz (JG), SHR 173.200**, vom 9.11.2009 (das JG ist zugleich kantonales Ausführungsrecht zur StPO). ⚠ Konkrete Art.-Nrn. für StA/JugA nicht aus dem PDF extrahierbar — verifizieren. |
| **Strafgericht/ZMG** | Querverweis Repo: ZMG/erstinstanzliche Strafkompetenz beim **Kantonsgericht SH** (Herrenacker 26); obere Instanz Obergericht SH. |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | Departement Inneres und Sicherheit. Zwei Bereiche: **Strafuntersuchung im Erwachsenenstrafrecht** und **Jugendanwaltschaft**. |
| **Adresse** | **Schützenstrasse 1A, 9100 Herisau** (Tel. 071 343 63 66). ⚠ Wichtig: StA/JugA sitzen in **Herisau, nicht Trogen** (Trogen = Gerichte). |
| **Jugendanwaltschaft** | Gleiche Adresse: **Schützenstrasse 1A, 9100 Herisau** (Tel. 071 343 63 56). |
| **Übertretungsstrafbehörden** | Keine separate Übertretungsstrafbehörde web-belegt. |
| **EG-StPO** | Organisationsgrundlage: **Justizgesetz (JG), bGS 145.31** (Behörden-Organisation), ergänzt durch das kantonale Ausführungsrecht zur StPO. ⚠ Art.-Nrn. für StA/JugA nicht extrahierbar — verifizieren; ob AR ein formell eigenständiges «EG-StPO» neben dem JG führt, blieb offen. |
| **Strafgericht/ZMG** | Querverweis Repo: erstinstanzlich **Kantonsgericht AR** (Trogen), obere Instanz Obergericht AR. |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | Justiz-, Polizei- und Militärdepartement. |
| **Adresse** | **Unteres Ziel 20, 9050 Appenzell** (Tel. 071 788 95 41). |
| **Jugendanwaltschaft** | Gleiche Adresse: **Unteres Ziel 20, 9050 Appenzell** (Tel. 071 788 95 51). |
| **Übertretungsstrafbehörden** | **Art. 8 EG-StPO** benennt eine Behörde für Übertretungen (Snippet-Niveau). |
| **EG-StPO** | **Einführungsgesetz zur Schweizerischen Strafprozessordnung (EG-StPO), GS 312.000**, vom 25.4.2010 ([lexfind tolv/206750](https://www.lexfind.ch/tolv/206750/de) · [ai.clex.ch 312.000](https://ai.clex.ch/app/de/texts_of_law/312.000)). **Mapping (Snippet-belegt, ⚠ am Volltext bestätigen):** Art. 5 Staatsanwaltschaft (Struktur) · Art. 6 Zuständigkeit/Rahmen · **Art. 7 Jugendanwaltschaft** · **Art. 8 Übertretungsstrafbehörde** · Art. 15 Beratungsstelle. |
| **Strafgericht/ZMG** | Querverweis Repo: erstinstanzlich **Bezirksgericht AI**, ZMG am Bezirksgericht (Art. 14 GOG GS 173.000); obere Instanz Kantonsgericht AI. |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | Vier **regionale Untersuchungsämter** + ein **Kantonales Untersuchungsamt** (Sonderfunktionen, kantonsweit; u. a. Wirtschaft/OK) + **Jugendanwaltschaft** + Stabsdienste. |
| **Adressen** | Untersuchungsamt St. Gallen: **St. Leonhard-Strasse 7, 9001 St. Gallen**. Weitere regionale UA: **Altstätten, Uznach, Gossau**. Kantonales Untersuchungsamt: St. Gallen. (⚠ Einzeladressen Altstätten/Uznach/Gossau und Kant. UA nicht final abgegriffen.) |
| **Jugendanwaltschaft** | **Spisergasse 22, 9001 St. Gallen** (ein Standort je Untersuchungsregion). |
| **Übertretungsstrafbehörden** | Keine separate web-belegt (Übertretungen über StA / Polizei-Ordnungsbussen). |
| **EG-StPO** | **Einführungsgesetz zur Schweizerischen Straf- und Jugendstrafprozessordnung (EG-StPO), sGS 962.1** ([gesetzessammlung.sg.ch 962.1](https://www.gesetzessammlung.sg.ch/app/de/texts_of_law/962.1)). Struktur StA/UA/JugA insb. um **Art. 6 ff. (Organisation)**; Art. 19 zitiert in der Strafprozessverordnung sGS 962.11. ⚠ Genaues Art.-Mapping (UA/Kant. UA/JugA) am Volltext bestätigen. |
| **Strafgericht/ZMG** | Querverweis Repo (`gerichtsbehoerden`/`gog`): Kreisgerichte (1. Inst.), Kantonsgericht/Anklagekammer; ZMG-Zuordnung dort. |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | Departement für Justiz, Sicherheit und Gesundheit. Hauptsitz Chur + dezentrale **Zweigstellen Davos, Ilanz, Thusis, Samedan, Roveredo**. |
| **Adresse** | **Rohanstrasse 5, 7000/7001 Chur** (Tel. 081 257 25 55; info@sta.gr.ch). |
| **Jugendanwaltschaft** | **Abteilung der Staatsanwaltschaft**, geleitet von einer/einem Leitenden Jugendanwält:in: **Rohanstrasse 5, 7001 Chur** (Tel. 081 257 25 82). |
| **Übertretungsstrafbehörden** | Keine separate web-belegt (Regelung im EGzStPO). |
| **EG-StPO** | **Einführungsgesetz zur Schweizerischen Strafprozessordnung (EGzStPO), BR 350.100**, vom 16.6.2010 ([gr-lex 350.100](https://www.gr-lex.gr.ch/app/de/texts_of_law/350.100)) + Verordnung BR 350.110. Regelt Stellung/Organisation/Zuständigkeit der Strafverfolgungsbehörden; **JugA als Abteilung der StA** ausdrücklich; StA-Sitz Chur + Zweigstellen. ⚠ Konkrete Art.-Nrn. (StA/JugA/Übertretungen) nicht aus PDF extrahierbar — verifizieren. |
| **Strafgericht/ZMG** | Querverweis Repo: **Regionalgerichte** (1. Inst.), **Kant. Zwangsmassnahmengericht** Chur (Art. 59–61 GOG BR 173.000), **Obergericht** (post-Justizreform, ab 1.1.2025). |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | **Oberstaatsanwaltschaft** (Gesamtleitung) + **Kantonale Staatsanwaltschaft** + **sechs regionale Staatsanwaltschaften** für die Bezirke. Departement Volkswirtschaft und Inneres (DVI). |
| **Adressen** | Oberstaatsanwaltschaft, Kantonale StA und Jugendanwaltschaft: **Aarau**. Regionale StA mit Sitzen in **Lenzburg, Zofingen, Baden, Muri, Brugg** (z. B. **StA Brugg-Zurzach, Wildischachen 14, 5200 Brugg**). (⚠ Einzeladressen Aarau/Lenzburg/Zofingen/Baden/Muri nicht final abgegriffen.) |
| **Jugendanwaltschaft** | Kantonsweit, Sitz **Aarau**; zuständig 10–18 J. (Untersuchung, Strafbefehl in leichten Fällen, Anklage vor Jugendgericht, Vollzug). |
| **Übertretungsstrafbehörden** | Keine separate kantonale Übertretungsstrafbehörde web-belegt; Übertretungen über StA. |
| **EG-StPO** | **Einführungsgesetz zur Schweizerischen Strafprozessordnung (EG StPO), SAR 251.200**, vom 5.10.2007, in Kraft 1.1.2011 ([gesetzessammlungen.ag.ch 251.200](https://gesetzessammlungen.ag.ch/app/de/texts_of_law/251.200)). Regelt Aufgaben StA durch Oberstaatsanwaltschaft, kant. StA und 6 Bezirks-StA. ⚠ Art.-Nrn. nicht aus PDF extrahierbar — verifizieren. (Hinweis: daneben Gesetz über die Strafrechtspflege SAR 251.100.) |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` AG): Bezirksgerichte (§ 50 ff. GOG SAR 155.200), ZMG aus BG-Präsidien (§ 60), Obergericht. |
...
| | |
|---|---|
| **Staatsanwaltschaft (Struktur)** | **Generalstaatsanwaltschaft** (mit **Ressort Übertretungen**) + **Abteilung Wirtschaftsstraffälle und Organisierte Kriminalität** + drei regionale Abteilungen **Frauenfeld, Bischofszell, Kreuzlingen** + **Jugendanwaltschaft**. |
| **Adressen** | Generalstaatsanwaltschaft + Ressort Übertretungen: **Frauenfeld** (Tel. 058 345 18 00; gsta@tg.ch). Jugendanwaltschaft: **Ringstrasse 19, 8510 Frauenfeld** (Tel. 058 345 19 40; juga@tg.ch). (⚠ Hausnummern der GSTA/regionalen Abt. nicht final abgegriffen — `staatsanwaltschaft.tg.ch`.) |
| **Jugendanwaltschaft** | Eigene Abteilung, kantonsweit: **Ringstrasse 19, 8510 Frauenfeld**. |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | **Ja: «Ressort Übertretungen» der Generalstaatsanwaltschaft** — verfolgt Übertretungen Erwachsener kantonsweit (der GSTA angegliedert). |
| **EG-StPO** | Ausführungsrecht: **Gesetz über die Strafrechtspflege (Strafprozessordnung), RB 312.1** und das Einführungsgesetz/Übergangsrecht (vgl. RB 311.1 EG-StGB). ⚠ Genaue Nummer/Artikel des StPO-Einführungsrechts für die StA-Organisation am Volltext bestätigen (Web-Snippet nannte u. a. RB 321.3 — unsicher). |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` TG): Bezirksgerichte (§ 14 ff. ZSRG RB 271.1), **ZMG § 23 ZSRG**, Obergericht. |
...
| | |
|---|---|
| **Ministero pubblico (Struktur)** | *Originalbezeichnung* **Ministero pubblico** (Staatsanwaltschaft). Geleitet vom **Procuratore generale** (Generalstaatsanwalt; aktuell A. Pagani) + 2 Stellvertreter; **22 procuratori pubblici**, kantonsweit zuständig. Zwei Sektionen (Gemeindelikte / Wirtschafts- und Finanzdelikte). |
| **Adressen** | Sitz **Via Pretorio 16, 6901 Lugano** (Tel. 091 815 53 11). Zweigstelle **Viale Stefano Franscini 17, 6500 Bellinzona** (Tel. 091 814 24 11). |
| **Jugendanklagebehörde** | **Magistratura dei minorenni** (Jugendgericht/-anklage; *dt.:* Jugendmagistratur): **Via Bossi 2A, 6901 Lugano** (Tel. 091 815 53 61). Der Magistrato dei minorenni führt Untersuchung und urteilt (StPO-Min). |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | Erstinstanzliche Strafverfolgung von Übertretungen über die **Pretura penale** (Sitz Bellinzona, Strafbefehl/contravvenzioni) — vgl. Repo `gog` TI, Art. 39–41 LOG. Keine separate Verwaltungs-Übertretungsbehörde web-belegt. |
| **EG-StPO** | Organisation im **LOG (Legge sull'organizzazione giudiziaria), RL 177.100** (vgl. Repo) sowie kantonalem StPO-Ausführungsrecht. ⚠ Genaue MP-Artikel im LOG nicht separat abgegriffen — verifizieren. |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` TI): Tribunale penale cantonale (Art. 42/50 LOG), Pretura penale; **Giudice dei provvedimenti coercitivi (GPC)** als eigenes Büro im Strafjustizsystem erwähnt. |
...
| | |
|---|---|
| **Ministère public (Struktur)** | *Originalbezeichnung* **Ministère public** (Staatsanwaltschaft). Leitung **Collège des procureurs** = Procureur général (E. Kaltenrieder) + 2 Procureurs généraux adjoints. **Ministère public central** + vier **Ministères publics d'arrondissement** (Lausanne, Est vaudois, La Côte, Nord vaudois). ~60 Staatsanwält:innen. |
| **Adressen** | Zentrale Information: `vd.ch/mp`. (⚠ Hausadressen der MP central / 4 Arrondissements nicht final abgegriffen — vor Übernahme abrufen.) |
| **Jugend-Strafbehörde** | **Tribunal des mineurs (TM)** — kantonsweit; der **juge des mineurs** führt allein die Untersuchung (= Anklagebehörde-Funktion) **und** urteilt. Adresse: **Chemin du Trabandan 28, 1014 Lausanne** (Greffe). |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | **Préfets/Préfectures** sind im Kanton VD die Übertretungsstrafbehörde (Autorité pénale en matière de contraventions). ⚠ Web-bekannt, hier aber nicht eigens belegt — verifizieren. |
| **EG-StPO** | Zwei Erlasse: **Loi sur le Ministère public (LMPu), RSV 173.21** (Organisation MP) + **Loi d'introduction du CPP (LVCPP)** für das Ausführungsrecht. ⚠ Art.-Mapping am Volltext bestätigen. Organisation der Gerichte: LOJV RSV 173.01 (Repo). |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` VD): Tribunaux d'arrondissement (Art. 96a LOJV), Tribunal des mesures de contrainte / Tribunal des mineurs (Art. 3 LOJV, lois spéciales). |
...
| | |
|---|---|
| **Ministère public (Struktur)** | *Originalbezeichnung* **Ministère public** / **Staatsanwaltschaft**. **Office central** (Sion) unter der Procureure générale adjointe + **drei Office régionaux**: **Haut-Valais (Brig)**, **Valais central (Sion)**, **Bas-Valais (St-Maurice)**, je unter einem/einer 1. Staatsanwält:in. |
| **Adressen** | Office central: **Rue des Vergers 9, CP 2305, 1950 Sion 2 Nord** (Tel. 027 607 84 00). Regionale Offices: Brig / Sion / St-Maurice (⚠ Hausadressen nicht final abgegriffen). |
| **Jugend-Strafbehörde** | **Tribunal des mineurs / Jugendgericht**, Sitz **Sion** — untersucht und urteilt Min.-Delikte; vgl. Repo `gog` VS (Art. 13 LOJ). |
| **Übertretungsstrafbehörden** | Keine separate kantonale Übertretungsstrafbehörde web-belegt (Übertretungen über MP). |
| **EG-StPO** | **Loi d'application du code de procédure pénale suisse (LACPP), RS 312.0** ([lex.vs.ch 312.0](https://lex.vs.ch/app/fr/texts_of_law/312.0)) — Organisation der Strafbehörden inkl. MP (4 Offices) + Tribunal des mineurs (Art. 13 LOJ). Organisation gemäss LOJ RS 173.1 (Repo). ⚠ Art.-Mapping am Volltext bestätigen. |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` VS): Tribunaux d'arrondissement (Straf, Art. 11 LOJ), **Tribunal des mesures de contrainte** Sion (Art. 12 LOJ). |
...
| | |
|---|---|
| **Ministère public (Struktur)** | *Originalbezeichnung* **Ministère public** / Parquet général. **Procureur général** + Stellvertreter + 11 Staatsanwält:innen + 9 stv. Staatsanwält:innen; **zentralisiert in La Chaux-de-Fonds**. |
| **Adresse** | **Passage de la Bonne-Fontaine 41, 2300 La Chaux-de-Fonds** (Tel. 032 889 61 70; ministere.public@ne.ch). |
| **Jugend-Strafbehörde** | **Juge des mineurs** als Anklage-/Untersuchungs- und Urteilsbehörde; **Tribunal pénal des mineurs** mit Sitzen **La Chaux-de-Fonds** (TR Montagnes/Val-de-Ruz) und **Boudry** (TR Littoral/Val-de-Travers). Vor dem TPM vertritt der Jugend-Staatsanwalt die Anklage. |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | Das **Ministère public ist zuständige Behörde für Übertretungen** gegen Bundes- und kantonales Recht (LI-CPP). Keine separate Übertretungsbehörde. |
| **EG-StPO** | **Loi d'introduction du Code de procédure pénale suisse (LI-CPP), RSN 322.0**, vom 27.1.2010 ([rsn.ne.ch 322.0](https://rsn.ne.ch/DATA/program/books/RSN2017/20174/htm/3220.htm)) + **LI-PPMin, RSN 323.0** (Jugend-StPO). Organisation der Behörden: OJN RSN 161.1 (Repo). ⚠ Art.-Mapping am Volltext bestätigen. |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` NE): Tribunal de police / Tribunal criminel / **Tribunal des mesures de contrainte** (Art. 31–32 OJN) bei den Tribunaux régionaux. |
...
| | |
|---|---|
| **Ministère public (Struktur)** | *Originalbezeichnung* **Ministère public**. **Procureur général** (O. Jornot) + 5 Premiers procureurs + 44 Procureurs; **vier Sektionen** (eine für komplexe Wirtschaftsdelikte). |
| **Adresse** | **Route de Chancy 6B, 1213 Petit-Lancy** · Postadresse **Case postale 3565, 1211 Genève 3** (zentrale Genfer Postlogik). |
| **Jugend-Strafbehörde** | **Tribunal des mineurs (TMin)** — der **juge des mineurs** führt allein die Untersuchung (Anklagefunktion) und urteilt. Adresse: **Rue des Chaudronniers 7 (Bâtiment F), CP 3686, 1211 Genève 3** (Tel. 022 327 60 10). 6 Berufsrichter + 12 Beisitzer. |
| **Übertretungsstrafbehörden (Art. 17 StPO)** | **Service des contraventions (SDC)** ist die Genfer Übertretungsstrafbehörde. ⚠ Web-bekannt, hier nicht eigens belegt — verifizieren. |
| **EG-StPO** | Organisation MP im **LOJ rsGE E 2 05** ([silgeneve E 2 05](https://silgeneve.ch/legis/data/rsg_e2_05.htm)). **Mapping (Volltext-belegt):** **Art. 76** Dotation (Procureur général, 48 Procureurs, 4 procureurs extraordinaires) · **Art. 77** Zuständigkeit (CPP + JStPO) · **Art. 78** Sektionen · **Art. 79** Procureur général (Leitung) · **Art. 80** Wahl Premiers procureurs · **Art. 82A** procureurs extraordinaires · **Art. 111** Tribunal des mineurs. Ausführungsrecht zusätzlich: LaCP rsGE E 4 10. |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` GE): Tribunal de police/correctionnel/criminel (Art. 95–100), **Tribunal des mesures de contrainte** (Art. 94 LOJ). |
...
| | |
|---|---|
| **Ministère public (Struktur)** | *Originalbezeichnung* **Ministère public**. **8 Staatsanwält:innen** inkl. 1 Procureur général, 1 procureur extraordinaire, 1 Greffier-chef; zentralisiert. |
| **Adresse** | **Chemin du Château 9, 2900 Porrentruy** (Tel. 032 420 33 30) — im Château de Porrentruy, wo (ausser dem Jugendgericht) alle Justizinstanzen sitzen. |
| **Jugend-Strafbehörde** | **Tribunal des mineurs** (juge des mineurs als Anklage-/Urteilsbehörde) — **abweichend vom Rest in Delémont**: **Rue des Marronniers 3, 2800 Delémont** (Tel. 032 420 71 80). Präsident + 4 Beisitzer. |
| **Übertretungsstrafbehörden** | Keine separate kantonale Übertretungsstrafbehörde web-belegt (über MP). |
| **EG-StPO** | **Loi d'introduction du Code de procédure pénale suisse (LiCPP), RSJU 321.1** ([rsju 321.1](https://rsju.jura.ch/fr/viewdocument.html?idn=20054&id=36695)). Organisation der Behörden: LOJ RSJU 181.1 (Repo). ⚠ Art.-Mapping am Volltext bestätigen. |
| **Strafgericht/ZMG** | Querverweis Repo (`gog` JU): juge pénal / Tribunal pénal (Art. 32 lit. e–f LOJ), **juge des mesures de contrainte** (Art. 32 lit. g LOJ). |
...
| | |
|---|---|
| **Struktur** | **Bundesanwaltschaft** = Staatsanwaltschaft des Bundes; autonome, institutionell unabhängige Bundesbehörde, geleitet vom/von der **Bundesanwält:in**. Hauptsitz Bern; **Aussenstellen/Zweigstellen Zürich, Lausanne und Lugano** (ja, Zürich UND Lausanne — plus Lugano). |
| **Adressen** | **Hauptsitz: Guisanplatz 1, 3003 Bern.** Zweigstelle Zürich: **Werdstrasse 138/140**. Zweigstelle Lausanne: **Route de Chavannes 31**. Zweigstelle Lugano: **Via Sorengo 3**. (Hinweis: Sitz ist Bern/Guisanplatz, **nicht** Wabern — Auftrags-Annahme «Wabern» nicht bestätigt.) |
| **StBOG-Artikel** (Fedlex-Volltext belegt, SR 173.71) | **Art. 7** Behörde (StA des Bundes = BA) · **Art. 8** Sitz Bern + «kann Zweigstellen einrichten und aufheben» · **Art. 9** Bundesanwält:in (Leitung, Organisationsreglement). |
| **Strafgericht** | Querverweis bestehendes Bund-Dossier: **Bundesstrafgericht (BStGer)**, Bellinzona — erstinstanzliche Bundesstrafgerichtsbarkeit + Beschwerdekammer (zugleich ZMG-Funktion im Bundesstrafprozess). |

### Aufsichtsbehörde über die Bundesanwaltschaft (AB-BA)

| | |
|---|---|
| **Struktur** | **Unabhängige Aufsichtsbehörde**, von der Vereinigten Bundesversammlung gewählt, **7 Mitglieder** (1 Bundesrichter:in, 1 Bundesstrafrichter:in, 2 im Anwaltsregister eingetragene Anwält:innen, 3 Fachpersonen), nebenamtlich; ständiges Sekretariat. Direkt der Bundesversammlung unterstellt, **nicht** in die Departementsstruktur eingebunden. Beaufsichtigt die «systemischen» Tätigkeiten der BA. |
| **Adresse** | **Bundesgasse 3, 3003 Bern** (Tel. 058 485 67 02; info@ab-ba.admin.ch); [ab-ba.admin.ch](https://ab-ba.admin.ch/). |
| **StBOG-Artikel** (Fedlex-Volltext belegt) | **Art. 23** Wahl/Zusammensetzung (7 Mitglieder) · **Art. 24** Unvereinbarkeit · **Art. 25** Amtsdauer · **Art. 26** Amtsenthebung · **Art. 27** Stellung/Organisation (+ Sekretariat) · **Art. 29** Aufsicht/Weisungsbefugnis (nur generelle Weisungen, keine Einzelfallweisungen) · **Art. 30** Auskünfte/Inspektionen · **Art. 31** weitere Aufgaben (Antrag auf Amtsenthebung, Verwarnung/Lohnkürzung). Ergänzend: Verordnung der Bundesversammlung SR 173.712.24. |

---

## Quellen (Auswahl, alle abgerufen 5.6.2026)

- ssk-cmp.ch Behördenverzeichnis: https://www.ssk-cmp.ch/de/behoerdenverzeichnis
- SH: https://sh.ch (Staatsanwaltschaft, Allg./Verkehrsabteilung, Jugendanwaltschaft); JG SHR 173.200
- AR: https://ar.ch/verwaltung/departement-inneres-und-sicherheit/staatsanwaltschaft/ (+ /jugendanwaltschaft/); JG bGS 145.31
- AI: https://www.ai.ch/.../staatsanwaltschaft ; EG-StPO GS 312.000 https://www.lexfind.ch/tolv/206750/de
- SG: https://www.sg.ch/recht/staatsanwaltschaft-jugendanwaltschaft/ ; EG-StPO sGS 962.1 https://www.gesetzessammlung.sg.ch/app/de/texts_of_law/962.1
- GR: https://www.gr.ch/.../sta/ ; EGzStPO BR 350.100 https://www.gr-lex.gr.ch/app/de/texts_of_law/350.100
- AG: https://www.ag.ch/.../dvi/organisation/staatsanwaltschaft ; EG StPO SAR 251.200 https://gesetzessammlungen.ag.ch/app/de/texts_of_law/251.200
- TG: https://staatsanwaltschaft.tg.ch/organisation.html/4402 (+ Ressort Übertretungen)
- TI: https://www4.ti.ch/poteri/giudiziario/giustizia-penale/ministero-pubblico (+ /magistratura-dei-minorenni)
- VD: https://www.vd.ch/mp ; https://www.vd.ch/ojv/tribunal-des-mineurs ; LMPu RSV 173.21
- VS: https://www.vs.ch/web/mp/organisation ; LACPP RS 312.0 https://lex.vs.ch/app/fr/texts_of_law/312.0
- NE: https://www.ne.ch/autorites/PJNE/ministere-public/ ; LI-CPP RSN 322.0
- GE: https://justice.ge.ch/.../public-prosecutors-office ; LOJ E 2 05 https://silgeneve.ch/legis/data/rsg_e2_05.htm (Art. 76–82A, 111); Tribunal des mineurs
- JU: https://www.jura.ch/JUST/Instances-judiciaires/Ministere-public/ ; LiCPP RSJU 321.1
- Bund: https://www.bundesanwaltschaft.ch/ ; StBOG SR 173.71 (Fedlex, Stand 1.1.2024) ; AB-BA https://ab-ba.admin.ch/

## Wichtigste Unsicherheiten (zusammengefasst)

1. **Artikel-Mappings der EG-StPO** sind durchgehend nur Snippet-/Strukturebene — die amtlichen PDFs liessen sich nicht zeichengenau ausziehen. **Einzig GE (LOJ Art. 76–82A/111), AI (EG-StPO Art. 5–8/15) und Bund (StBOG Art. 7–9, 23–31) sind volltext-/snippetbelegt mit konkreten Nummern.** Alle übrigen Art.-Nrn. vor Stammdaten-Übernahme am amtlichen Volltext verifizieren (Daueranweisung: nie aus dem Gedächtnis).
2. **Hausadressen** der dezentralen StA-Standorte (AG Aarau/Lenzburg/Zofingen/Baden/Muri; SG Altstätten/Uznach/Gossau + Kant. UA; TG GSTA/regionale Abt.; VD/VS Arrondissement-Büros) sind nur teilweise abgegriffen.
