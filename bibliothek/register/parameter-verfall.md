...
| Fedlex-Re-Pins terminiert: StGB 12.6.2026 (AS 2026 231) · ZGB+ZPO 1.7.2026 (AS 2026 94/16) | `scripts/fedlex-cache.sh` ← `normen/fedlex-pin-nachverifikation-2026-06.md` | Voraus-Check 7.6.2026: KEINE zitierten Artikel betroffen — reine Re-Pins; StGB/ZPO-Dateien liegen als No-Suffix (n=0!) | einmalig je Stichtag (`check:caches` + `check:zitate` danach) | 12.6.2026 / 1.7.2026 |
...
| Handelsregisterämter-Adressen 26 Kt. | nur Dossier (`behoerden/handelsregisteraemter-kantone.md`) — nicht verdrahtet | amtliche kantonale Behördenseiten, Abruf 7.6.2026 (zefix-REST-API der EHRA: 401, Abgleich offen) | jährlich; **ZG-Adresse (Umzug 10/2025) prüfen**; zefix-Abgleich sobald API-Zugang | ZG + zefix: vor Abnahme |
...
| Betreibungsämter-Stammdaten 26 Kt. (117 Kreis- + 10 Einheitsämter, Gemeinde-Karten 8 Kt.) | `src/data/betreibungsaemter.ts` + `src/data/betreibung/aemterKantone.json` ↔ `behoerden/betreibungskreise-kantone.md` — **VERDRAHTET 7.6.2026** | Extraktion + adversariale Stichproben 7.6.2026 (49/49 Adressen); **ZG/SZ/AG/LU/UR/SG nur Verzeichnis-Link** (ZG-PDF 2/2023, AG-Verbands-URL tot → ag.ch-Inspektorat) · **BE: Moutier-Kantonswechsel 1.1.2026 → Reorganisation Berner Jura/Biel innert 3 J. («Avenir Berne romande»)** | **jährlich**; ZH bei Inkrafttreten der Kreis-Reorganisation KOMPLETT neu; BE-Jura-Dienststellen ab 2027 prüfen | Jan. 2027 (ZH halbjährlich, s. eigene Zeile) |
