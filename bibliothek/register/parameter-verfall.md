...
| Betreibungsämter-Verzeichnisse 26 Kt. (Listen-Stände) | nur Dossier (`behoerden/betreibungskreise-kantone.md`) — nicht verdrahtet | Abruf 7.6.2026; **ZG-PDF Stand 2/2023** · **AG-Verzeichnis-URL beim Prüflauf nicht erreichbar (ECONNREFUSED)** · LU laufende Fusionen (zuletzt 2024) · BE 4 Regionen erst seit 1.1.2026 · ZH EG SchKG: zitiert V129, aktuell V132 (§§ 1–3 unverändert) | jährlich + zwingend vor Verdrahtung (`betreibungsaemter.ts`, Plan); ZG/AG vorab klären | vor Bau Etappe 1 |
