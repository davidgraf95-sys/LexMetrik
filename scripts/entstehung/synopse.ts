...
// Quelllücken-Erkennung (QuellLuecke/QuellLueckenBefund/QUELLLUECKE_STAENDE_MAX/
// findeQuellLuecken) ist nach `./quellluecken.ts` ausgelagert (§6.6-Split); re-exportiert
// hier unverändert, damit kein Konsumenten-Importpfad sich ändert (Fassaden-Muster).
export * from './quellluecken.ts';
