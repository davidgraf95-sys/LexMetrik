...
import { RechnerUebersicht } from '../src/pages/RechnerUebersicht';
import { VorlagenUebersicht } from '../src/pages/VorlagenUebersicht';
...
const SEITEN: [string, React.ComponentType][] = [
  ...
  ['VorlagenUebersicht', VorlagenUebersicht],
