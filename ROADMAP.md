...
- [ ] **Davids Alltags-Fehlerfunde** *(`W2·18-FEHLERBUCH`, stehender Sammel-Schritt, Entscheid David 8.8.2026)*
  ...
  **Detail:** [FAHRPLAN-OFFENE-BEFUNDE.md](fahrplaene/FAHRPLAN-OFFENE-BEFUNDE.md) §4 — dort die
  ...
  - [ ] **`check:schlankheit` rot auf main: `scripts/normtext/adapter-lexwork.ts` 926 Z. (Baseline 839)** *(Nullprobe zweier Fixer 12.9.2026 auf 6aca2901e)* — §6.6-Split in Leaf-Module, Baseline nicht anheben; Risikopfad ⇒ Golden byte-gleich + Gegenprüfung (kein Jules-Ticket).
