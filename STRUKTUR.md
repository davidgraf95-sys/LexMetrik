...
- **PROD-DEPLOY 23.6.2026** (Commits `77c5aa3` + `85db3cf`, sauberer /tmp-HEAD-Worktree §12.3): `dpl_H7yq4NAFxuvwMmrEdAFA8FXdqDmE`, lexmetrik.vercel.app READY. Nachkontrolle: Kernrouten + `/normtext/register.json` + `/rechtsprechung/register.json` HTTP 200; Live-Suche interaktiv verifiziert (Lazy-Fetch erst beim Tastendruck). **Noch NICHT zu origin gepusht** (David verlangte nur Deploy; main ist ahead).
