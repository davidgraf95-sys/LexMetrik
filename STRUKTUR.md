...
- **OFFEN (Groundwork gelegt, §1 vor Tempo):** SR-0.*-Verträge als VOLLTEXT (9 ELIs aufgelöst) + weitere SR 0.* kuratieren — alles in **`FAHRPLAN-INTERNATIONAL-VOLLTEXT.md`** (ELI-Pins + Key-Normalisierungs-Caveat LugÜ→LUGUE).
