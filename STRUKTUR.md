...
**Wartet auf David:** Lagebild gut so? · Dependabot-Konfig (M2: monatlich, `rebase-strategy: disabled`) landen? · Repo privat: Weg A/B/C (`@david-fragen`) · Go «Entstehung am Artikel» (§11.9) · Lagebild Sitzung 2.
