...
**Offen (kein Blocker):** Gesetz-/Entscheid-Titel im Zuletzt-Tracker (~½ Session, Schreibzeit-Auflösung via lazy Manifeste) · Doks-Wording «deterministisch statt KI-geschätzt» · milde Doppel-Beschriftung Schnellrechner-Seclabel vs. Karten-Overline (Davids Geschmacksentscheid). Detail ROADMAP W2·5c + `FAHRPLAN-STARTSEITE-V3.md` §13.
