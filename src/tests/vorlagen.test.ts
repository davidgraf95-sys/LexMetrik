...
import {
  TESTAMENT_SCHEMA, testamentZusammenstellen, pruefeGates,
} from '../lib/vorlagen/testament';
import {
  PV_DEFAULT_MASSNAHMEN, PV_SCHEMA, pvZusammenstellen, pruefePvGates, zielDefaults,
} from '../lib/vorlagen/patientenverfuegung';
import { basis, pv } from './vorlagen.helfer';
