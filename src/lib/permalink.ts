 ...
 *  «2026-02-30» passierte den Wächter). Logik lebt in datumsUtils
 *  (/simplify Reuse#3) — hier nur der Spec-übliche Name. */
export { istGueltigesISO as istISO } from './datumsUtils';
