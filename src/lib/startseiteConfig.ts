...
const KARTEN: Record<string, CalculatorCard> = {
  ...
  fristenspiegel: {
    ...
    description: 'Ein auslösendes Ereignis startet mehrere Fristen zugleich – der Spiegel zeigt sie als Tabelle mit Fristnatur, Norm und Kalender-Export, gerechnet von den bestehenden Fach-Engines (er rechnet nichts selbst). Fünf Ereignisse: erstinstanzlicher Zivilentscheid (Berufung/Beschwerde-Weiche, Dispositiv-Vorstufe), Zahlungsbefehl (Rechtsvorschlag, Art.-88-Dual), Klagebewilligung, Vermieter-Kündigung (Anfechtung/Erstreckung) und Erbgang (Ausschlagung/Inventar).',
    status: 'entwurf',
    norms: [
    ...
    related: ['mietrecht', 'zpo-fristen', 'schkg-fristen', 'erbrecht-fristen', 'zustaendigkeit'],
    keywords: ['Fristenspiegel', 'parallele Fristen', 'Kündigung erhalten', 'Urteil erhalten', 'Zahlungsbefehl erhalten', 'Anfechtung', 'Erstreckung', 'Berufung', 'Beschwerde', 'Rechtsvorschlag', 'Ausschlagung', 'Klagebewilligung', 'Fristenkontrolle'],
    szenarien: [
      ...
      { label: 'AG-Kündigung: Einsprache & 336b-Klagefrist', status: 'geplant' },
    ],
    icon: 'clock',
  },
  'ferien-checker': {
