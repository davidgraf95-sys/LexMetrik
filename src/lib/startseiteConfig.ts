...
export const RECHTSGEBIET_SEKTIONEN: { name: string; id: string; lede: string }[] = [
  ...
  { name: 'Immobilien / Grundstückkauf', id: 'immobilien',
...
const KARTEN: Record<string, CalculatorCard> = {
  ...
  'notariat-grundbuch': {
    id: 'notariat-grundbuch', modus: 'rechner', art: 'betrag', rechtsgebiet: 'Immobilien / Grundstückkauf',
    rechtsbereich: 'privat',
    title: 'Notariats- & Grundbuchkosten (Grundstückkauf)',
    description: 'Erwerbs-Nebenkosten beim Grundstückkauf aller 26 Kantone: Beurkundungsgebühr (Notariat) + Grundbucheintrag, optional Grundpfand (Schuldbrief) und Handänderungssteuer – kantonale Tarife mit amtlicher Quelle, interkantonaler Vergleich. Aufwand-/Verhandlungstarife (freies Notariat) ehrlich als Spanne; Handänderungssteuer als getrennter Steuerblock. Erstrecherche, nicht abgenommen.',
    status: 'entwurf',
    norms: [
      { label: 'Art. 657 ZGB', url: fedlexUrl('ZGB', '657'), verified: false },
    ...
    keywords: ['Notariatskosten', 'Beurkundung', 'Grundbuchgebühr', 'Handänderungssteuer', 'Grundstückkauf', 'Liegenschaftskauf', 'Was kostet ein Hauskauf', 'Schuldbrief', 'Notar', 'Grundpfand', 'Eigentumsübertragung'],
    icon: 'percent',
  },
  streitwert: {
