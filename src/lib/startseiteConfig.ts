...
const KARTEN: Record<string, CalculatorCard> = {
  ...
  fristenspiegel: {
    ...
    description: 'Ein auslösendes Ereignis startet mehrere Fristen zugleich – der Spiegel zeigt sie als Tabelle mit Fristnatur, Norm und Kalender-Export, gerechnet von den bestehenden Fach-Engines (er rechnet nichts selbst). Ereignisse: Vermieter-Kündigung (Anfechtung/Erstreckung) und erstinstanzlicher Zivilentscheid (Berufung/Beschwerde mit Streitwert- und Verfahrens-Weiche, Dispositiv-Vorstufe); Zahlungsbefehl und Erbgang folgen.',
    status: 'entwurf',
    norms: [
    ...
    related: ['mietrecht', 'zpo-fristen', 'zustaendigkeit', 'tagerechner'],
    keywords: ['Fristenspiegel', 'parallele Fristen', 'Kündigung erhalten', 'Urteil erhalten', 'Anfechtung', 'Erstreckung', 'Berufung', 'Beschwerde', 'Art. 273', 'Fristenkontrolle'],
    szenarien: [
