...
import { SCHRITTE, PHASEN, ERSTELLER_LABEL, CHF, BEREICH_SCHRITT, BANNER_ENTWURF, VR_ZEICHNUNGS_OPTIONEN, VERTRETUNGS_ZEICHNUNGS_OPTIONEN, STORAGE_KEY, ladeStand, txt, bool, wahl, zeilenGuard, GRUENDER_LEER, VR_LEER, VERTRETUNG_LEER, SACHEINLAGE_LEER, VERRECHNUNG_LEER, VORTEIL_LEER } from './vorlagenAgGruendungDaten';
